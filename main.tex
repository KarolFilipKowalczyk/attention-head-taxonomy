...
\input{stack_math}
\input{stack_code}
\input{stack_pedagogy}
\input{stack_identity}
\input{stack_meta_reasoning}
...
This work introduces a unified naming framework for attention heads in modern transformer models. We provide a four-level depth model (Early/Middle/Late/Final), a stack-based functional taxonomy (14 stacks), canonical names for attention head types, and a comprehensive cross-reference for historical terminology.
